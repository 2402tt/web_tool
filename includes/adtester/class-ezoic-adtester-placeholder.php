...
class Ezoic_AdTester_Placeholder
{
	...
	const JS_EMBED_CODE_TEMPLATE = '<!-- Ezoic - %s - %s --><div id="ezoic-pub-ad-placeholder-%d"%s data-inserter-version="%d" data-placement-location="%s"></div><script data-ezoic="1">ezstandalone.cmd.push(function () { ezstandalone.showAds(%d); });</script><!-- End Ezoic - %s - %s -->';
